          ...
          <div class="card bg-dark text-white" style="height:550px;">
            ...
            <div class="card-body ">
              <ul class="">
                ...
                <div class="col-md-8" style="float:left"><img src="/storage/avatars/{{$row->avatar}} " alt="" style="width:50px; height:50px;top:0px;right:90px;border-radius:50%;margin-right:20px; " ><span>{{$row->name}}</span></div></div>
